/**
 * @generated SignedSource<<a8351cf57bb4c6d1932a5904bf457f04>>
...
export type SinglePostFeed_comments$data = {
  readonly comments: {
  ...
  readonly id: string;
  readonly " $fragmentType": "SinglePostFeed_comments";
};
export type SinglePostFeed_comments$key = {
  readonly " $data"?: SinglePostFeed_comments$data;
...
return {
  ...
  "metadata": {
    ...
    "refetch": {
      ...
      "operation": require('./SinglePostFeedPaginationQuery.graphql'),
      "identifierField": "id"
    }
  },
