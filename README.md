...
+ İngilizce ve Türkçe dil yeterliğiniz iyiyse yardımınıza ihtiyacımız var!
	1. _Issue_ kısmında çevrilmeyi bekleyen metinlerden birini seçin.
...
+ **HTML etiketlerini, olaylarını ve metotlarını çevirmeyiniz.** <br> _(örn. <button.>, onClick, preventDefault)_ 
...
+ **Sayfa sonlarında verilen dış linkleri çevirmeyiniz.** <br> _(örn. [Go deep into Javascript events with this video](https://www.youtube.com/watch?v=8aGhZQkoFbQ&t=1235s)_
