...
Bu, `main` dalınızı yalnızca düzgün çalıştığını bildiğiniz bitmiş özellikler için tutabileceğiniz ve her özelliği, _özellik (feature) dalları_ olarak adlandırdığımız dalları kullanarak projenize ekleyebileceğiniz anlamına gelir.
