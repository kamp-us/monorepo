...
Olası her veri öğesi için uygun girdi türünü belirlemeniz gerekir çünkü genelde veri öğelerini toplamanın birden çok yolu olmasına rağmen kullanıcınız için tek bir kolay yol vardır.

Bu derste, HTML formlarının temellerini ve kullanabileceğiniz farklı girdi türlerinden bazılarını keşfedeceğiz.
