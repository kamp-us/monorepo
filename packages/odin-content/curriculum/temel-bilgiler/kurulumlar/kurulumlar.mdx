...
<div className="lesson-note" markdown="1">
...
<summary className="dropDown-header">Sanal Makine (Önerilen) </summary>
...
<details markdown="block">
<summary className="dropDown-header">Ubuntu/Windows Dual-Boot </summary>
...
<details markdown="block">
<summary className="dropDown-header">ChromeOS/ChromeOS Flex </summary>
...
<details markdown="block">
<summary className="dropDown-header">Linux</summary>
...
<details markdown="block">
<summary className="dropDown-header">MacOS</summary>
